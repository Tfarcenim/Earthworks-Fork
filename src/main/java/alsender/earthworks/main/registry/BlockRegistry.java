...
//      block_chalk_dust = new Block_ChalkDust();
        ...
        plaster_slab = new SlabBlock(Block.Properties.from(lath_and_plaster));
        rammed_earth_slab = new SlabBlock(Block.Properties.from(rammed_earth));
        slate_slab = new SlabBlock(Block.Properties.from(blue_slate));
        ...
        slab_slate_slab = new SlabBlock(Block.Properties.from(polished_blue_slate));
        ...
        slate_tile_slab = new SlabBlock(Block.Properties.from(blue_slate_tiles));
        green_slate_tile_slab = new SlabBlock(Block.Properties.from(green_slate_tiles));
        purple_slate_tile_slab = new SlabBlock(Block.Properties.from(purple_slate_tiles));
        ...
        wattle_slab = new SlabBlock(Block.Properties.from(wattle_and_daub));
        ...
        slate_stairs = new StairsBlock(blue_slate.getDefaultState(),Block.Properties.from(blue_slate));
        ...
        slate_slab_stairs = new StairsBlock(polished_blue_slate.getDefaultState(),Block.Properties.from(polished_blue_slate));
        ...
        slate_tile_stairs = new StairsBlock(blue_slate_tiles.getDefaultState(),Block.Properties.from(blue_slate_tiles));
        ...
        wattle_stairs = new StairsBlock(wattle_and_daub.getDefaultState(),Block.Properties.from(wattle_and_daub));
        ...
        wall_plaster = new WallBlock(Block.Properties.from(lath_and_plaster));
        wall_rammed_earth = new WallBlock(Block.Properties.from(rammed_earth));
        wall_slate = new WallBlock(Block.Properties.from(blue_slate));
        ...
        wall_slate_slab = new WallBlock(Block.Properties.from(polished_blue_slate));
        ...
        wall_slate_tile = new WallBlock(Block.Properties.from(blue_slate_tiles));
        wall_slate_tile_verte = new WallBlock(Block.Properties.from(green_slate_tiles));
        wall_slate_tile_purple = new WallBlock(Block.Properties.from(purple_slate_tiles));
        ...
        wall_wattle = new WallBlock(Block.Properties.from(wattle_and_daub));
