...
public class BlockRegistry {
    ...
    public static Block lath_and_plaster_slab;
    public static Block rammed_earth_slab;
    public static Block reed_slab;
    public static Block blue_slate_slab;
    public static Block green_slate_slab;
    public static Block purple_slate_slab;
    public static Block polished_blue_slate_slab;
    public static Block polished_green_slate_slab;
    public static Block polished_purple_slate_slab;
    public static Block blue_slate_shingles_slab;
    public static Block green_slate_shingles_slab;
    public static Block purple_slate_shingles_slab;
    public static Block blue_slate_tiles_slab;
    public static Block green_slate_tiles_slab;
    public static Block purple_slate_tiles_slab;
    public static Block thatch_slab;
    public static Block oak_timber_slab;
    public static Block birch_timber_slab;
    public static Block spruce_timber_slab;
    public static Block jungle_timber_slab;
    public static Block acacia_timber_slab;
    public static Block dark_oak_timber_slab;
    public static Block wattle_and_daub_slab;
    public static Block wicker_slab;
    public static Block oak_wood_shakes_slab;
    public static Block spruce_wood_shakes_slab;
    public static Block birch_wood_shakes_slab;
    public static Block jungle_wood_shakes_slab;
    public static Block acacia_wood_shakes_slab;
    public static Block dark_oak_wood_shakes_slab;
    ...
    public static Block reed_stairs;
    public static Block blue_slate_stairs;
    public static Block green_slate_stairs;
    public static Block purple_slate_stairs;
    public static Block polished_blue_slate_stairs;
    public static Block polished_green_slate_stairs;
    public static Block polished_purple_slate_stairs;
    public static Block blue_slate_shingles_stairs;
    public static Block green_slate_shingles_stairs;
    public static Block purple_slate_shingles_stairs;
    public static Block blue_slate_tile_stairs;
    ...
    public static Block wattle_and_daub_stairs;
    ...
    public static Block cinder_wall;
    public static Block cob_wall;
    public static Block concrete_wall;
    public static Block cordwood_wall;
    public static Block dry_fitted_stone_wall;
    public static Block GRAVEL_GABION_WALL;
    public static Block SAND_GABION_WALL;
    public static Block DIRT_GABION_WALL;
    public static Block mud_wall;
    public static Block lath_and_plaster_wall;
    public static Block rammed_earth_wall;
    public static Block reed_wall;
    public static Block blue_slate_wall;
    public static Block green_slate_wall;
    public static Block purple_slate_wall;
    public static Block polished_blue_slate_wall;
    public static Block polished_green_slate_wall;
    public static Block polished_purple_slate_wall;
    public static Block blue_slate_shingles_wall;
    public static Block wall_slate_shingle_verte;
    public static Block wall_slate_shingle_purple;
    public static Block blue_slate_tiles_wall;
    public static Block green_slate_tiles_wall;
    public static Block purple_slate_tiles_wall;
    public static Block thatch_wall;
    public static Block oak_timber_wall;
    public static Block birch_timber_wall;
    public static Block spruce_timber_wall;
    public static Block jungle_timber_wall;
    public static Block acacia_timber_wall;
    public static Block dark_oak_timber_wall;
    public static Block wattle_and_daub_wall;
    public static Block wicker_wall;
    public static Block oak_wood_shakes_wall;
    public static Block spruce_wood_shakes_wall;
    public static Block birch_wood_shakes_wall;
    public static Block jungle_wood_shakes_wall;
    public static Block acacia_wood_shakes_wall;
    public static Block dark_oak_wood_shakes_wall;
...
//      block_chalk_dust = new Block_ChalkDust();
        ...
        blue_slate_tile_stairs = new StairsBlock(blue_slate_tiles.getDefaultState(),Block.Properties.from(blue_slate_tiles));
        green_slate_tile_stairs = new StairsBlock(green_slate_tiles.getDefaultState(),Block.Properties.from(green_slate_tiles));
        purple_slate_tile_stairs = new StairsBlock(purple_slate_tiles.getDefaultState(),Block.Properties.from(purple_slate_tiles));
        ...
        oak_shingle_stairs = new StairsBlock(oak_wood_shakes.getDefaultState(),Block.Properties.from(oak_wood_shakes));
        spruce_shingle_stairs = new StairsBlock(spruce_wood_shakes.getDefaultState(),Block.Properties.from(oak_wood_shakes));
        birch_shingle_stairs = new StairsBlock(birch_wood_shakes.getDefaultState(),Block.Properties.from(oak_wood_shakes));
        jungle_shingle_stairs = new StairsBlock(oak_wood_shakes.getDefaultState(),Block.Properties.from(oak_wood_shakes));
        acacia_shingle_stairs = new StairsBlock(oak_wood_shakes.getDefaultState(),Block.Properties.from(oak_wood_shakes));
        dark_oak_shingle_stairs = new StairsBlock(oak_wood_shakes.getDefaultState(),Block.Properties.from(oak_wood_shakes));
        ...
        wall_slate_shingle_verte = new WallBlock(Block.Properties.from(green_slate_shingles));
        wall_slate_shingle_purple = new WallBlock(Block.Properties.from(purple_slate_shingles));
