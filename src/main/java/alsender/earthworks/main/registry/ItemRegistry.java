...
public class ItemRegistry {
    ...
    public static void initItems(RegistryEvent.Register<Item> event) {
        ...
        itemslab_adobe = blockItem(BlockRegistry.adobe_slab);
        chalk_slab = blockItem(BlockRegistry.chalk_slab);
        cinder_slab = blockItem(BlockRegistry.cinder_slab);
        itemslab_cob = blockItem(BlockRegistry.cob_slab);
        itemslab_concrete = blockItem(BlockRegistry.concrete_slab);
        itemslab_cordwood = blockItem(BlockRegistry.cordwood_slab);
        itemslab_dry_stone = blockItem(BlockRegistry.dry_stone_slab);
        itemslab_gabion0 = blockItem(BlockRegistry.gabion0_slab);
        itemslab_gabion1 = blockItem(BlockRegistry.gabion1_slab);
        itemslab_gabion2 = blockItem(BlockRegistry.gabion2_slab);
        itemslab_mud = blockItem(BlockRegistry.mud_slab);
        ...
        itemslab_rammed_earth = blockItem(BlockRegistry.rammed_earth_slab);
        itemslab_slate = blockItem(BlockRegistry.slate_slab);
